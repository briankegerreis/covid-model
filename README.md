...
where the additional parameters are : 
 - oLD strategy of the Lockdown (1 or 2, see Supplementary Methods).
 - "intervention time", i.e. cumulative fraction of the population that has to be infected  before the intervention is made  
 - pLD probability to remove each vertex in strategy 1. 
 - mLD maximum number of edges per vertex in strategy 2.
...
where the additional parameters are: 
 - d fraction of the population that we can vaccinate with the available doses
 - v "vaccination time", i.e. cumulative fraction of the population that has to be infected  before the intervention is made
 - w which categories of individuals you can vaccinate (1: only susceptibles S, 2: susceptible, recovered or infected SIR)
 - f efficacy of the vaccin
